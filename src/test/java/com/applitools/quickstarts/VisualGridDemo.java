...
class AppTest {
    ...
    public void VGTest() {
        ...
        webDriver.get("https://youronce.brmcloud.co.uk/");
        ...
        conf.setApiKey("d3y09FgnUVZ6d1IvaKIGw103RytSwqmTL9hL4G4dnwxqc110");    // Set the Applitools API KEY here or as an environment variable "APPLITOOLS_API_KEY"
        conf.setTestName("First Test")   // Set test name
